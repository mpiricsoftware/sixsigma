...
<!-- Page Scripts -->
@section('page-script')
    @vite(['resources/js/site-manage.js'])
@endsection
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-datatable table-responsive">
            <table class="datatables-site table">
                <thead>
                    <tr>
                        <th></th>
                        <th>Id</th>
        ...
        <!-- Offcanvas to add new site -->
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddSite" aria-labelledby="offcanvasAddSiteLabel">
            <div class="offcanvas-header border-bottom">
                <h5 id="offcanvasAddSiteLabel" class="offcanvas-title">Add Site</h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body mx-0 flex-grow-0 h-100">
                <form class="add-new-site pt-0" id="addNewsiteForm">
