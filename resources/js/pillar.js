...
$(function () {
    var dataTableform = $('.datatables-pillar'),
      select2 = $('.select2'),
      offModalForm = $('#addpillarModal'),
      offModalEditForm = $('#editpillarModal');
        ...
        columnDefs: [
...

          {
            ...
            render: function (data, type, full, meta) {
             ...
             `<button data-id="${full.id}" class="btn btn-sm btn-icon btn-text-secondary rounded-pill delete-record text-body waves-effect waves-light me-1">
    ...
    const addformpillar = document.getElementById('addformpillar');

    // form form validation
    const fa = FormValidation.formValidation(addformpillar, {
        fields: {
            form_name: {
                validators: {
                    notEmpty: {
