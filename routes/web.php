...
Route::group(['middleware' => ['auth','verified']], function ($request)
{
    Route::group(['middleware' => ['role:Super Admin']], function () {
        ...
        Route::get('/app/access-permission', [AccessPermission::class, 'AccessPermission'])->name('app-access-permission');
        Route::resource('/role-list', AccessRoles::class);

        Route::get('/admin', [adminController::class, 'adminManage'])->name('adminManage');
    ...
    Route::get('company',[companyController::class, 'CompanyManage'])->name('CompanyManage');
    Route::get('company/add/getstate',[companyController::class, 'getstate']);
    Route::get('company/add/getcities',[companyController::class,'getcities']);
    ...
    Route::get('/details/{slug}',[InquiryController::class,'details'])->name('details');
  ...
  Route::get('/cities/{stateId}', function ($stateId) {
    ...
    Route::put('/app/access-roles/{id}/edit', [AccessRoles::class, 'update'])->name('app-access-roles.edit');
    Route::put('/app/access-roles/{id}', [AccessRoles::class, 'update'])->name('app-access-roles.update');
    Route::delete('/app/access-roles/{id}', [AccessRoles::class, 'destroy'])->name('app-access-roles.destroy');
